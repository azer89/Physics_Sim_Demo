                                                                             ...
                                                                             )
{
    ...
    {
        mButton0Pressed = false;
        mListener->bulletButton0Released ();
    }
    if (BULLET_BUTTON1_UP)
    {
        mButton1Pressed = false;
        mListener->bulletButton1Released ();
    }
    if (BULLET_BUTTON2_UP)
    {
        mButton2Pressed = false;
        mListener->bulletButton2Released ();
    }
